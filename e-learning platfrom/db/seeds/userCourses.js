  ...
  return knex('userCourses').del()
    .then(function () {
      return knex("userCourses").insert([
        { uid: 1, cid: 1, score: 10 , review: 'Example Review 1'},
        { uid: 1, cid: 4, score: -1 , review: 'Example Review 2'},
        { uid: 5, cid: 1, score: -1 },
        { uid: 5, cid: 3, score: -1 },
        { uid: 5, cid: 4, score: -1 },
        { uid: 1, cid: 6, score: -1 , review: 'Example Review 4'},
        { uid: 3, cid: 4, score: -1 , },
        { uid: 4, cid: 6, score: -1 , },
        { uid: 5, cid: 6, score: -1 , },
        { uid: 8, cid: 6, score: -1 , },
        { uid: 8, cid: 2, score: -1 , },
        { uid: 8, cid: 5, score: -1 , review: 'Example Review 3'},
      ]);
    });
};
